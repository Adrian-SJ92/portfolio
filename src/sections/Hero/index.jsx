  ...
  return (
    <section id="hero" className="hero">
      ...
      <div className="container hero__content">
        <div className="hero__avatar-small">
          <img src={avatarImg} alt="Adrian" />
        </div>
        ...
        <div className="hero__socials">
          ...
          <a href={PERSONAL.instagram} target="_blank" rel="noreferrer" className="hero__social" aria-label="Instagram">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
