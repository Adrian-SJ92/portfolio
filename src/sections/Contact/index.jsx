      ...
      <div className="container">
        ...
        <div className="contact__wrapper">
          <form className="glass-card contact__form" onSubmit={handleSubmit}>
            ...
            {status === 'success' && (
              <p className="contact__feedback contact__feedback--success">{t('contact.success')}</p>
            )}
            {status === 'error' && (
              <p className="contact__feedback contact__feedback--error">{t('contact.error')}</p>
            )}
          ...
          <div className="contact__info">
            <a href={`tel:${PERSONAL.phone}`} className="glass-card contact__card">
              ...
              <div>
                <span className="contact__card-label">Teléfono</span>
                <span className="contact__card-value">{PERSONAL.phoneDisplay}</span>
              </div>
            </a>
            ...
            <a href={PERSONAL.github} target="_blank" rel="noreferrer" className="glass-card contact__card">
              ...
              <div>
                ...
                <span className="contact__card-value">github.com/Adrian-SJ92</span>
              </div>
            </a>

            <a href={PERSONAL.linkedin} target="_blank" rel="noreferrer" className="glass-card contact__card">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                ...
                <span className="contact__card-value">linkedin.com/in/adrian-sanchez-jim</span>
              </div>
            </a>
          </div>
        </div>
